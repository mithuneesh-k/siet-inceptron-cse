const TYPE_CONFIG = {
  hackathon: { icon: 'âš¡', label: 'Hackathon', cls: 'type-hackathon badge' },
  internship: { icon: 'ðŸ’¼', label: 'Internship', cls: 'type-internship badge' },
  course: { icon: 'ðŸ“š', label: 'Course', cls: 'type-course badge' },
  project: { icon: 'ðŸš€', label: 'Project', cls: 'type-project badge' },
  certification: { icon: 'ðŸ…', label: 'Certification', cls: 'type-certification badge' },
};

const POSITION_LABEL = { '1st': 'ðŸ¥‡ 1st Place', '2nd': 'ðŸ¥ˆ 2nd Place', '3rd': 'ðŸ¥‰ 3rd Place', participated: 'ðŸŽ–ï¸ Participated' };
const DURATION_LABEL = { short: '< 1 Month', medium: '1â€“3 Months', long: '3+ Months' };
  ...
  return (
    <div className="achievement-card card card-hover animate-fadeInUp">
      <div className="ach-top">
        ...
        {!achievement.verified && <span className="badge badge-error">â³ Pending Approval</span>}
      ...
      <div className="ach-meta">
        ...
        {achievement.duration && (
          <span className="badge badge-blue">â±ï¸ {DURATION_LABEL[achievement.duration]}</span>
        )}
        {achievement.proof_url && (
          <a href={achievement.proof_url} target="_blank" rel="noopener noreferrer" className="badge badge-violet">ðŸ”— Proof</a>
        )}
      </div>
