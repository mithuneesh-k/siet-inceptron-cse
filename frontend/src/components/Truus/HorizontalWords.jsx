        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <h2 className="display horizontal-words__h2" aria-label="We build the next generation">
                        {"We build the next generation".split('').map((char, index) => (
                            char === ' ' ? <span key={`space-${index}`}> </span> : (
                                <div key={index} className="letter" aria-hidden="true" style={{ position: "relative", display: "inline-block" }}>
                                    {char}
                                </div>
                            )
                        ))}
            ...
            <div className="horizontal-words__bottom-text">
                <div className="horizontal-words__bottom-text-l">
                    Opportunities are more abundant <em>and</em> more accessible<br />
                    than ever. We help students become leaders in<br />
