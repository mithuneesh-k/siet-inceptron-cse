...
export default function MotionCards() {
    ...
    return (
        <section
            ...
            {/* â”€â”€â”€ Part 1: Bold Heading Text with SVG Sticker Placeholders â”€â”€â”€ */}
            <div className="motion-card__heading">
                ...
                <p className="motion-card__subtitle">
                    from TV to TikTok.
                    {/* SVG sticker placeholder â€” top-right area */}
            ...
            {/* â”€â”€â”€ Part 2: Cards with Colorful Bars & Blue Blob â”€â”€â”€ */}
            <div className="motion-card__cards-area">
                ...
                {/* Floating labels â€” positioned freely over the cards area */}
            ...
            {/* â”€â”€â”€ Part 3: Bottom Paragraph Text â”€â”€â”€ */}
            <div className="motion-card__footer-text">
                <p className="motion-card__description">
                    ...
                    they are. We are a true 360Â° agency, working the
