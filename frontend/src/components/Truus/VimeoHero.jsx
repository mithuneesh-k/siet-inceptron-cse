...
export default function VimeoHero() {
    ...
    /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
       â‘£ Hover mute bubble â€” same GSAP elastic spring as CursorBubble
    â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    useEffect(() => {
    ...
    return (
        <>
            {/* â‘£ Hover mute bubble â€” follows cursor over the video */}
            <div
                ref={bubbleRef}
            ...
            >
                <div className="vimeo-mute-bubble__blob">
                    ...
                    />
                    {/* Mute icon (shown when sound is ON â†’ click to mute) */}
                    ...
                    {/* Unmute icon (shown when muted â†’ click to unmute) */}
            ...
            >
                <video
                    ref={iframeRef}
                    src="https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-connection-background-loop-21142-large.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
                ...
                {/* â‘  Headline â€” bottom left, word-by-word layout */}
                <div className="home-header__title">
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* "mainstream" + â‘¤ pink star (no spin) + oval underline */}
                        <span className="vimeo-hero__word is--relative">
                ...
                {/* â‘  Controls â€” bottom LEFT: pause/play + fullscreen */}
